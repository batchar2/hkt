...
var RouterProvider = /** @class */ (function (_super) {
    ...
    RouterProvider.prototype.render = function () {
        return (React__default.createElement(routerContext.Provider, { value: this.props.router },
            React__default.createElement(routeContext.Provider, { value: __assign({ router: this.props.router }, this.routeState) }, this.props.children)));
    };
...
var BaseLink = /** @class */ (function (_super) {
    ...
    BaseLink.prototype.render = function () {
        ...
        var linkclassName = (active ? [activeClassName] : [])
            ...
            .join(' ');
        return React__default.createElement('a', __assign({}, linkProps, { href: href, className: linkclassName, onClick: this.clickHandler }), children);
    };
    return BaseLink;
}(React.Component));
...
function withRouter(BaseComponent) {
    return function WithRouter(props) {
        return (React__default.createElement(routerContext.Consumer, null, function (router) { return React__default.createElement(BaseComponent, __assign({}, props, { router: router })); }));
    };
}

function withRoute(BaseComponent) {
    return function withRoute(props) {
        return (React__default.createElement(routeContext.Consumer, null, function (routeContext$$1) { return React__default.createElement(BaseComponent, __assign({}, props, routeContext$$1)); }));
    };
}
...
var RouteNodeRenderer = /** @class */ (function (_super) {
    ...
    RouteNodeRenderer.prototype.shouldComponentUpdate = function (nextProps) {
        return router5TransitionPath.shouldUpdateNode(this.props.nodeName)(nextProps.route, nextProps.previousRoute);
    };
...
var RouteNode = function (props) {
    return (React__default.createElement(routeContext.Consumer, null, function (routeContext$$1) { return React__default.createElement(RouteNodeRenderer, __assign({}, props, routeContext$$1)); }));
};

function routeNode(nodeName) {
    return function (BaseComponent) {
        function RouteNodeWrapper(props) {
            return (React__default.createElement(RouteNode, { nodeName: nodeName }, function (routeContext) { return (React__default.createElement(BaseComponent, __assign({}, props, routeContext))); }));
        }
...
function useRouter$1(nodeName) {
    ...
    React.useEffect(function () {
        return router.subscribe(function (_a) {
            var route = _a.route, previousRoute = _a.previousRoute;
            var shouldUpdate = router5TransitionPath.shouldUpdateNode(nodeName)(route, previousRoute);
            if (shouldUpdate) {
                setState({
                    route: route,
                    previousRoute: previousRoute
...
exports.useRouteNode = useRouter$1;
